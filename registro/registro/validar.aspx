<%@ Page Language="VB" AutoEventWireup="false" CodeFile="validar.aspx.vb" Inherits="validar" %>
...
<div id="header">
	<div class="logo">
	<a style="outline:none; text-decoration:none; outline-color:none" href="login.aspx"><img src="img/LOGO2025.png"></a>
	</div>
</div>
</header>
<center>
  	<div class="letra">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title text-center form-title">Activar cuenta</h1>
          </div>
          <div class="modal-body padtrbl">
            <div class="login-box-body">
              ...
              <!----- password -------------->
               <div class="row">
               <div class="col-xs-12">
    		 <label style=" color:#000;  font-family: 'typewriter_condensedregular';">Contraseña: </label>
             </div>
            <div class="col-xs-12">
			<asp:TextBox runat="server" class="form-control3" placeholder="XXXXXXXXXX" id="txtloginpsw" required="" type="password" autocomplete="off" name=""></asp:TextBox>
                   ...
                   <!---btn login --> 
                    <div class="row" align="center">
                         <div class="col-xs-12">
                            <asp:button runat="server" type="submit" ID="btnactivar" Text="ACTIVAR" class="button8"  />
                            <%--    <asp:button runat="server" type="submit" ID="Button1" Text="ACTIVAR" class="btn" onclick="userlogin()" />--%>
                        </div>
                    </div>
