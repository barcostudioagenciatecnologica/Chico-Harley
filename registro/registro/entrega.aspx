<%@ Page Language="VB" AutoEventWireup="false" CodeFile="entrega.aspx.vb" Inherits="entrega" %>
                ...
                <div class="centrar" >
                    ...
                    <nav>
                        <ul>
                             ...
                             <li>
                                <a id="active" href="entrega.aspx"><i class="fa fa-certificate" aria-hidden="true"></i> ENTREGA DE ARTICULOS</a>
                            </li>
                           <li>
                                <a  href="participantes.aspx"><i class="fa fa-users" aria-hidden="true"></i> PARTICIPANTES</a>
                            </li>
                            <li>
  	    ...
  	    <div class="letra">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title text-center form-title">Entrega de Playeras o Parches</h1>
              </div>
                ...
                <div class="login-box-body">
                  <div class="form-group">
                      <div>
                           <div class="row">
                   <div class="col-xs-12">
    		     <label style=" color:#fff">Búsqueda: </label>
                 </div>
                                <div class="col-xs-9">
                    <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control3 " type="search" placeholder="Escriba aquí"  MaxLength="50" autocomplete="off" name="" style="box-shadow: 0 1px 4px 0 rgba(0, 0, 0, 0.35); border:2px solid #393A3C"  ></asp:TextBox>
                                    </div>
                    &nbsp;
                               <div  class="col-xs-3 ">
...
<div id="modalStock" class="modal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background-color:rgba(0,0,0,0.5); z-index:9999; justify-content:center; align-items:center;">
    ...
    <script>
        ...
        function actualizarCantidad(id, boton) {
            ...
            $.ajax({
                type: "POST",
                url: "entrega.aspx/ActualizarStock",
                contentType: "application/json; charset=utf-8",
