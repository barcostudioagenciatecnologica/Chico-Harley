<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Cierre.aspx.vb" Inherits="formularioContacto" %>
...
<div class="container">
	...
	<div class="menu-container js_nav-item">
		...
		<div class="logo">
			...
			<img class="logo-img logo-img-main" src="img/logo2024.png">
			<img class="logo-img logo-img-active" src="img/logo2024.png">
			</a>
		</div>
		<!-- End Logo -->
	</div>
	...
	<%--	<p class="titulo">
		...
		<form  id="contactForm" runat="server" method="post" novalidate >
			<div class="row">
                <center>
				<div class="col-md-12">
					<h1 class="cerrado">Registro cerrado</h1>
                    </div>
           
			</div>

			<%--<br>
			<div style=" width:100%; max-width:900px; background-color:#454040; height:2px">
			</div>
			<br>
			<br>--%>
		</form>
