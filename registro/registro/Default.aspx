	...
	<div class="collapse navbar-collapse nav-collapse">
		<div class="adfa">
			<p>
				...
				&nbsp;&nbsp;<a href="login.aspx" >Administrador</a>
			</p>
		</div>
		<br>
...
<!--========== END HEADER ==========-->
    ...
    <div class="bannerindex">
        ...
        <img src="Imagenes Chico Harley/pagina 1.png" />
    </div>
...
<div class="tabla1">
	<div class="letra">
        ...
        <p class="fuentena2">
			Reiteramos nuestro agradecimiento a todos y cada uno de los que hacen posible que este evento se lleve a cabo.
		</p>
        ...
        <br>
		<p class="fuentena3">
			<b>MARCA: HARLEY, HONDA, SUZUKI, YAMAHA…</b>
		</p>
		<p class="fuentena2">
			<b>MODELO: 1995, 2000, 2010…</b>
		</p>
        	<p class="fuentena2">
			<b>CILINDRADA: 250cc, 750cc, 1200cc</b>
		</p>
		<br>
          <p class="fuentena2">
        ...
        <form runat="server">
		<div class="acepto">
			<asp:Checkbox runat="server" ID="checkbox" type="checkbox" onchange="javascript:checar()"  /> <span style="color:#000 !important; font-family: 'typewriter_condensedregular';">He leído y acepto.</span>  <br>
			<br>
...
<%--<script src="js/menu/layout.min.js" type="text/javascript"></script>--%>
